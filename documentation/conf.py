...
nitpick_ignore = [
    ...
    ( 'py:class', "appcore.generics.Result" ),
    ...
    ( 'py:class', "librovore.__.interfaces.DisplayTarget" ),
    ( 'py:class', "librovore.cli._CliCommand" ),
    ( 'py:class', "librovore.processors.Detection" ),
    ( 'py:class', "librovore.processors.InventoryDetection" ),
    ( 'py:class', "librovore.processors.Processor" ),
    ( 'py:class', "librovore.processors.StructureDetection" ),
    ( 'py:class', "librovore.results.ContentQueryResult" ),
    ( 'py:class', "librovore.results.DetectionsResult" ),
    ( 'py:class', "librovore.results.ErrorResponse" ),
    ( 'py:class', "librovore.results.InventoryObject" ),
    ( 'py:class', "librovore.results.InventoryQueryResult" ),
    ( 'py:class', "librovore.results.ProcessorsSurveyResult" ),
    ( 'py:class', "librovore.results.SearchResult" ),
    ( 'py:class', "librovore.state.Globals" ),
